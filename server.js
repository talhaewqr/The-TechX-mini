...
const BOT_NAME = process.env.BOT_NAME || "𝙏𝙝𝙚 𝙏𝙚𝙘𝙝𝙓";
const OWNER_NAME = process.env.OWNER_NAME || "*SILVERxZAMAN*";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "YOUR STATUS HAS BEEN SEEN BY 𝙏𝙝𝙚 𝙏𝙚𝙘𝙝𝙓 mini bot 🫶🏻";
...
👤 Owner: *${OWNER_NAME}*`;
                ...
                await conn.sendMessage(from, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            title: "⚡ 𝙏𝙝𝙚 𝙏𝙚𝙘𝙝𝙓 MINI Speed Test",
            ...
            case 'menu':
                ...
                await conn.sendMessage(from, {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        externalAdReply: {
                            title: "📃 𝙏𝙝𝙚 𝙏𝙚𝙘𝙝𝙓 MINI Command Menu",
...
function gracefulShutdown() {
  ...
  isShuttingDown = true;
  console.log("\n🛑 Shutting down The TechX- MINI server...");
